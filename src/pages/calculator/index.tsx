  ...
  return (
      <CalculatorContainer $isActive={isActive}>
        ...
        <ContainerTeclas $isActive={isActive}>
          <ContainerNumbers operator={operator} isActive={isActive} currentNumber={currentNumber} setCurrentNumber={setCurrentNumber} SetFirstNumber={SetFirstNumber} setOperator={setOperator} firstNumber={firstNumber}/>
        </ContainerTeclas >
      </CalculatorContainer>
